...
plusFloatMPFR :: Float -> Float -> Float
plusFloatMPFR a b = realToFrac $ unsafePerformIO $ mpfrAdd 24 (realToFrac a) (realToFrac b)
...
plusFloatExample clk a b =
  delayN xp undefined enableGen clk (liftA2 plusFloatMPFR a b)
