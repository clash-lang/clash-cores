...
getPolarity nm ty =
  error
    ("Could not determine ResetPolarity for ResetPort @\"" <> nm <> "\" from\n " <> show ty)
...
instance
  (IsPort p0, IsPort p1, IsPort p2, IsPort p3, IsPort p4, IsPort p5) =>
  Inst (p0, p1, p2, p3, p4, p5)
instance
  (IsPort p0, IsPort p1, IsPort p2, IsPort p3, IsPort p4, IsPort p5, IsPort p6) =>
  Inst (p0, p1, p2, p3, p4, p5, p6)
instance
  (IsPort p0, IsPort p1, IsPort p2, IsPort p3, IsPort p4, IsPort p5, IsPort p6, IsPort p7) =>
  Inst (p0, p1, p2, p3, p4, p5, p6, p7)
instance
  ( IsPort p0
  , IsPort p1
  , IsPort p2
  ...
  Inst (p0, p1, p2, p3, p4, p5, p6, p7, p8)
instance
  ( IsPort p0
  , IsPort p1
  , IsPort p2
  ...
  Inst (p0, p1, p2, p3, p4, p5, p6, p7, p8, p9)
instance
  ( IsPort p0
  , IsPort p1
  , IsPort p2
  ...
  Inst (p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10)
instance
  ( IsPort p0
  , IsPort p1
  , IsPort p2
  ...
  Inst (p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11)
instance
  ( IsPort p0
  , IsPort p1
  , IsPort p2
  ...
  Inst (p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12)
instance
  ( IsPort p0
  , IsPort p1
  , IsPort p2
  ...
  Inst (p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13)
instance
  ( IsPort p0
  , IsPort p1
  , IsPort p2
  ...
  Inst (p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14)
instance
  ( IsPort p0
  , IsPort p1
  , IsPort p2
  ...
  Inst (p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15)
instance
  ( IsPort p0
  , IsPort p1
  , IsPort p2
  ...
  Inst (p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16)
instance
  ( IsPort p0
  , IsPort p1
  , IsPort p2
  ...
  Inst (p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17)
instance
  ( IsPort p0
  , IsPort p1
  , IsPort p2
  ...
  Inst (p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18)
instance
  ( IsPort p0
  , IsPort p1
  , IsPort p2
...
tyToPrimPort (splitTyConAppM -> Just (tyConName'@(Name{nameOcc = Text.unpack -> tyConName}), args))
  ...
  , LitTy (SymTy nm) : _ <- args =
      Left
        ( "Can't translate Param " <> nm <> " to PrimPort. Did you define a Param in a result type?"
        )
  | tyConName == show 'Port
