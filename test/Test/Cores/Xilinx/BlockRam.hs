...
testsCycleBoth =
  testGroup
    ...
    , testCase "test8" $ cyc (writeToAddr 0 66) (writeToAddr 0 77)
        @?= "([undefined,22],undefined,undefined)"
    , testCase "test9" $ cyc (writeToAddr 0 66) (writeToAddr 0 66)
        @?= "([undefined,22],undefined,undefined)"
    , -- Write with undefined enable
      testCase "test10" $ cyc (uReadFromAddr 0) doNothing
        @?= "([11,22],undefined,44)"
    , testCase "test11" $ cyc doNothing (uReadFromAddr 0)
        @?= "([11,22],33,undefined)"
    , testCase "test12" $ cyc (uReadFromAddr 0) (uReadFromAddr 0)
        @?= "([11,22],undefined,undefined)"
    , testCase "test13" $ cyc (uWriteToAddr 0 66) doNothing
        @?= "([undefined,22],undefined,44)"
    , testCase "test14" $ cyc doNothing (uWriteToAddr 0 66)
        @?= "([undefined,22],33,undefined)"
    , testCase "test15" $ cyc (uWriteToAddr 0 66) (uWriteToAddr 1 77)
        @?= "([undefined,undefined],undefined,undefined)"
    , testCase "test16" $ cyc (uWriteToAddr 0 66) (uWriteToAddr 0 77)
        @?= "([undefined,22],undefined,undefined)"
    , testCase "test17" $ cyc (uWriteToAddr 0 66) (uWriteToAddr 0 66)
        @?= "([undefined,22],undefined,undefined)"
    , -- Repeat earlier tests, but with undefined enable
      testCase "test18" $ cyc (readFromAddr u) doNothing
        @?= "([11,22],undefined,44)"
    , testCase "test19" $ cyc doNothing (readFromAddr u)
        @?= "([11,22],33,undefined)"
    , testCase "test20" $ cyc (readFromAddr u) (readFromAddr u)
        @?= "([11,22],undefined,undefined)"
    , testCase "test21" $ cyc (writeToAddr u 66) doNothing
        @?= "([undefined,undefined],undefined,44)"
    , testCase "test22" $ cyc doNothing (writeToAddr u 66)
        @?= "([undefined,undefined],33,undefined)"
    , testCase "test23" $ cyc (writeToAddr u 66) (writeToAddr u 77)
        @?= "([undefined,undefined],undefined,undefined)"
    , testCase "test24" $ cyc (writeToAddr u 66) (writeToAddr u 77)
        @?= "([undefined,undefined],undefined,undefined)"
    , testCase "test25" $ cyc (writeToAddr u 66) (writeToAddr u 66)
        @?= "([undefined,undefined],undefined,undefined)"
    , testCase "test26" $ cyc (uReadFromAddr u) doNothing
        @?= "([11,22],undefined,44)"
    , testCase "test27" $ cyc doNothing (uReadFromAddr u)
        @?= "([11,22],33,undefined)"
    , testCase "test28" $ cyc (uReadFromAddr u) (uReadFromAddr u)
        @?= "([11,22],undefined,undefined)"
    , testCase "test29" $ cyc (uWriteToAddr u 66) doNothing
        @?= "([undefined,undefined],undefined,44)"
    , testCase "test30" $ cyc doNothing (uWriteToAddr u 66)
        @?= "([undefined,undefined],33,undefined)"
    , testCase "test31" $ cyc (uWriteToAddr u 66) (uWriteToAddr u 77)
        @?= "([undefined,undefined],undefined,undefined)"
    , testCase "test32" $ cyc (uWriteToAddr u 66) (uWriteToAddr u 77)
        @?= "([undefined,undefined],undefined,undefined)"
    , testCase "test33" $ cyc (uWriteToAddr u 66) (uWriteToAddr u 66)
        @?= "([undefined,undefined],undefined,undefined)"
    , testProperty
        "prop_definedOutputCycleBothWord16"
        (prop_definedOutputCycleBoth (Gen.enumBounded @_ @Word16))
    , testProperty
        "prop_definedOutputCycleBothBitVector16"
...
tests =
  testGroup
    "Tests.Cores.Xilinx.BlockRam.Internal"
    [ testsAccessRam
    , testsCycleBoth
    ]
